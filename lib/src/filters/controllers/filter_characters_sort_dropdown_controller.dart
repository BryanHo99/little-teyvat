...
final AutoDisposeProvider<FilterCharactersSortDropdownController> filterCharactersSortDropdownController =
    Provider.autoDispose<FilterCharactersSortDropdownController>(
